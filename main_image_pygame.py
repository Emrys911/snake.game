...
# Difficulty settings
difficulty = 10  # Adjust as needed (e.g., 10 for easy, 25 for medium, etc.)
...
while game_running:
    ...
    if snake_pos[0] < 0 or snake_pos[0] > frame_size_x - block_size or snake_pos[1] < 0 or snake_pos[
        1] > frame_size_y - block_size:
        game_over()
